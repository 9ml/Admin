      ...
      <el-col class="tm-mains" :span="24">
        ...
        >
          <el-table-column
            ...
            align="center"
          >
            <div slot-scope="scope" class="dis-center">
              <el-image
                style="width:40px;height:40px;margin-right:16px;"
                fit="cover"
                :src="scope.row.goods_image"
              ></el-image>
              <span class="hiddenFonts">{{scope.row.goods_name}}</span>
            </div>
          </el-table-column>
          <el-table-column
            label="单价"
            ...
            align="center"
          >
            <span slot-scope="scope" style="color:#FF0000;">￥{{scope.row.goods_price}}/100g</span>
          </el-table-column>
          <el-table-column
            label="购买重量"
            prop="goods_num"
            ...
            align="center"
          >
            <span slot-scope="scope" style="color:#FF0000;">{{scope.row.goods_price}}斤</span>
          </el-table-column>
          <el-table-column
            label="买家信息"
            prop="order_soup_num"
          ...
          <el-table-column
            ...
            align="center"
          >
            <span slot-scope="scope" style="color:#FF0000;">￥ {{scope.row.working_price}}</span>
          </el-table-column>
          <el-table-column
            label="订单总价"
            width="120"
          ...
          <el-form label-position="left" inline class="table-expand">
            ...
            <el-row>
              <el-col :offset="1" :span="22">
                ...
                <el-form-item class="t-e-item" label="粉料总价：">
                ...
                <el-form-item class="t-e-item" label="加工费用：">
                  <span style="color:#FF0000;">￥ {{orderData.working_price}}</span>
                </el-form-item>
                ...
                <el-form-item class="t-e-item" label="支付价格：">
                  ...
                  <el-tooltip class="item" effect="dark" content="支付价格 = 粉料总价 * 会员折扣 + 加工费用 + 运费价格" placement="right">
        ...
        <el-tab-pane label="订单商品" name="goods">
          ...
          >
            ...
            <el-table-column
              ...
              align="center"
            >
              <span slot-scope="scope" style="color:#FF0000;">{{scope.row.goods_num}} 斤</span>
            </el-table-column>
            <el-table-column
              label="总价"
              prop="totalPrice"
        ...
        <el-col class="tm-mains" :span="24">
          ...
          >
            ...
            <el-table-column
              ...
              align="center"
            >
              <span slot-scope="scope" style="color:#FF0000;">￥ {{scope.row.workPrice}}</span>
            </el-table-column>
            <el-table-column
              label="运费价格"
              prop="freight"
...
<script>
  import { pOrder , oHandlePowder , userAddress , orderLogistics , orderLog } from '@/api/purchase';
