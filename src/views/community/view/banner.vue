  ...
  <div>
    ...
    >
      ...
      <el-row class="ed-item">
        ...
        <el-col class="ed-m-tips" :span="1">
          <el-tooltip class="item" effect="dark" content="内部链接请填写具体帖子ID,外部链接请填写链接地址" placement="top">
            <i class="el-icon-question"></i>
          </el-tooltip>
        </el-col>
      </el-row>
...
<script>
  import { bannerList , addBanner , updateBanner , delBanner } from '@/api/community';
