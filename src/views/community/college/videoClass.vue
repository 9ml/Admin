...
<script>
  ...
  import { videoClassList , addVideoClass , updateVideoClass , delVideoClass } from '@/api/community';
  export default {
    data() {
      return {
        // 表格数据
    ...
    methods: {
      ...
      tableData(){
        ...
        videoClassList(params).then(res=>{
      ...
      handleSure(){
        ...
        switch(this.openType){
          ...
          case 2:
            ...
            updateVideoClass(data).then(res=>{
              if(res){
